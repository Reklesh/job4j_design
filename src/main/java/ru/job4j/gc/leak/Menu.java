...
public class Menu {
    ...
    private static final String ALL_POSTS_DELETED = "Все посты удалены";
    ...
    private static void start(CommentGenerator commentGenerator, Scanner scanner,
        ...
        while (run) {
            ...
            if (ADD_POST == userChoice) {
                ...
                postStore.removeAll();
                System.out.println(ALL_POSTS_DELETED);
            } else {
                run = false;
    ...
    private static void createPost(PostStore postStore, String text) {
