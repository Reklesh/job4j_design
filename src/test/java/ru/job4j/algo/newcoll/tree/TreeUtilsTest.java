...
class TreeUtilsTest {
    ...
    void checkCount() {
        ...
        assertThat(treeUtils.countNode(new Node<>(10, new Node<>(20))))
                .isEqualTo(2);
        assertThatThrownBy(() -> treeUtils.countNode(null))
    ...
    void checkFindAll() {
        ...
        assertThatThrownBy(() -> treeUtils.findAll(null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    @Test
    void checkKeyNotFound() {
        Node<Integer> root = new Node<>(1);
        Optional<Node<Integer>> result = treeUtils.divideByKey(root, 2);
